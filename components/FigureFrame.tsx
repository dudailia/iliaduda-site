...
export function FigureFrame({
  ...
  return (
    <figure id={id} className="my-12 lg:my-16" aria-labelledby={`${id}-title`}>
...
export function Readouts({ rows }: { rows: readonly { readonly label: string; readonly value: ReactNode }[] }) {
  return (
